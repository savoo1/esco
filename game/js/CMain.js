function CMain(oData) {
  ...
  this.preloaderReady = function () {
    this._loadImages();
    if (
      (DISABLE_SOUND_DESKTOP === false && s_bMobile === false) ||
              ...
              if (
                ...
                s_aSounds[s_aSoundsInfo[i].ingamename].once(
                  ...
                  function () {
                    ...
                    if (
                      s_aSoundsInfo[i].ingamename === "ambience_game" &&
                      s_oGame !== null
                    ) {
  ...
  this._loadImages = function () {
    ...
    s_oSpriteLibrary.addSprite("mask_slot", "./sprites/mask_slot.webp");
    s_oSpriteLibrary.addSprite(
      "win_frame_anim_0",
      "./sprites/win_frame_anim_0.webp"
    );
    s_oSpriteLibrary.addSprite(
      "win_frame_anim_1",
      "./sprites/win_frame_anim_1.webp"
    );
    s_oSpriteLibrary.addSprite(
      "win_frame_anim_big_0",
      "./sprites/win_frame_anim_big_0.webp"
    );
    s_oSpriteLibrary.addSprite(
      "win_frame_anim_big_1",
      "./sprites/win_frame_anim_big_1.webp"
    );
    s_oSpriteLibrary.addSprite(
      "win_frame_anim_big_2",
      "./sprites/win_frame_anim_big_2.webp"
    );
    s_oSpriteLibrary.addSprite(
      "win_frame_anim_big_3",
      "./sprites/win_frame_anim_big_3.webp"
    );
    s_oSpriteLibrary.addSprite(
      "win_frame_anim_big_4",
      "./sprites/win_frame_anim_big_4.webp"
    );
    s_oSpriteLibrary.addSprite(
      "win_frame_anim_big_5",
      "./sprites/win_frame_anim_big_5.webp"
    );
    s_oSpriteLibrary.addSprite(
      "win_frame_anim_big_6",
      "./sprites/win_frame_anim_big_6.webp"
    );
    s_oSpriteLibrary.addSprite(
      "win_frame_anim_big_7",
      "./sprites/win_frame_anim_big_7.webp"
    );
    s_oSpriteLibrary.addSprite("but_text", "./sprites/but_text.webp");
    s_oSpriteLibrary.addSprite("msg_box", "./sprites/msg_box.webp");
    s_oSpriteLibrary.addSprite("msg_box_small", "./sprites/msg_box_small.webp");
    s_oSpriteLibrary.addSprite(
      "but_arrow_next",
      "./sprites/but_arrow_next.webp"
    );
    s_oSpriteLibrary.addSprite(
      "but_arrow_prev",
      "./sprites/but_arrow_prev.webp"
    );
    s_oSpriteLibrary.addSprite("logo", "./sprites/logo.webp");
    s_oSpriteLibrary.addSprite(
      "bg_loading_bonus",
      "./sprites/bg_loading_bonus.jpg"
    );
    s_oSpriteLibrary.addSprite("but_exit_info", "./sprites/but_exit_info.webp");
    s_oSpriteLibrary.addSprite(
      "bg_freespins_off",
      "./sprites/bg_freespins_off.jpg"
    );
    s_oSpriteLibrary.addSprite(
      "bg_freespins_on",
      "./sprites/bg_freespins_on.jpg"
    );
    s_oSpriteLibrary.addSprite(
      "amount_freespins",
      "./sprites/amount_freespins.webp"
    );
    s_oSpriteLibrary.addSprite(
      "amount_freespin_win",
      "./sprites/amount_freespin_win.webp"
    );
    s_oSpriteLibrary.addSprite(
      "amount_bonus_win",
      "./sprites/amount_bonus_win.webp"
    );

    for (var t = 0; t < NUM_SYMBOLS; t++) {
      s_oSpriteLibrary.addSprite(
        "symbol_" + t,
        "./sprites/symbol_" + t + ".webp"
      );
      for (var k = 0; k < 8; k++) {
        s_oSpriteLibrary.addSprite(
          "symbol_" + t + "_" + k,
          "./sprites/symbols/symbol_" + t + "_" + k + ".jpg"
        );
      }
    }

    s_oSpriteLibrary.addSprite("bet_but", "./sprites/paylines/bet_but.webp");
    s_oSpriteLibrary.addSprite("but_credits", "./sprites/but_credits.webp");
    s_oSpriteLibrary.addSprite(
      "but_delete_savings",
      "./sprites/but_delete_savings.webp"
    );
    s_oSpriteLibrary.addSprite("but_exit", "./sprites/but_exit.webp");
    s_oSpriteLibrary.addSprite(
      "but_fullscreen",
      "./sprites/but_fullscreen.webp"
    );
    s_oSpriteLibrary.addSprite("but_no", "./sprites/but_no.webp");
    s_oSpriteLibrary.addSprite("but_play", "./sprites/but_play.webp");
    s_oSpriteLibrary.addSprite("but_yes", "./sprites/but_yes.webp");
    s_oSpriteLibrary.addSprite("ctl_logo", "./sprites/ctl_logo.webp");
    s_oSpriteLibrary.addSprite("but_credits", "./sprites/but_credits.webp");
    s_oSpriteLibrary.addSprite("audio_icon", "./sprites/audio_icon.webp");
    ...
    for (var j = 1; j < NUM_PAYLINES + 1; j++) {
      s_oSpriteLibrary.addSprite(
        "payline_" + j,
        "./sprites/paylines/payline_" + j + ".webp"
      );
    }
    ...
    for (var j = 0; j < 37; j++) {
      s_oSpriteLibrary.addSprite(
        "thunder_avatar_" + j,
        "./sprites/thunder_avatar/thunder_avatar_" + j + ".webp"
      );
    }
    ...
    for (var k = 2; k < 50; k++) {
      s_oSpriteLibrary.addSprite(
        "big_win_" + k,
        "./sprites/big_win/big_win_" + k + ".webp"
      );
    }
